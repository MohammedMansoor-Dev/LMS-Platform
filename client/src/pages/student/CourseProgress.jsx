      ...
      <div className='flex flex-col md:flex-row gap-6'>
        <div className='flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4'>
          <div>
            ...
            <video src={currentLecture?.videoUrl || initialLecture.videoUrl} controls controlsList="nodownload" className='w-full h-auto md:rounded-lg' onPlay={() => handleLectureProgress(currentLecture?._id || initialLecture._id)}
            />
          </div>
        ...
        <div className='flex flex-col w-full md:w-2/5 border-t- md:border-t-0 md:border-l border-gray-200 pl-4 pt-4 md:pt-0'>
          <h2 className='font-bold text-xl mb-4'>Course Lecture</h2>
