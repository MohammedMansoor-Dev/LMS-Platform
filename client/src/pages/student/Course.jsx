                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center gap-3'>
                                <Avatar className='h-8 w-8'>
                                    <AvatarImage className='rounded-full' src={course.creator?.photoUrl || "https://github.com/shadcn.png"} />
                                    <AvatarFallback>{course.creator?.name ? course.creator.name[0] : 'U'}</AvatarFallback>
