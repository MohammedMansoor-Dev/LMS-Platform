        ...
        <div className='space-y-5'>
            ...
            <div className='max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-10'>
                <div className='w-full lg:w-1/2 space-y-5'>
                    ...
                    <p className='text-sm text-justify' dangerouslySetInnerHTML={{ __html: course?.description }} />
                    <Card>
                        <CardHeader>
                    ...
                    <Card>
                        <CardContent className='p-4 flex flex-col'>
                            <div className='w-full aspect-video mb-4'>
                                <ReactPlayer width='100%' height={'100%'} url={course.lectures[0].videoUrl} controls />
                            </div>
                            <h1>Lecture title</h1>
                        ...
                        <CardFooter className='flex justify-center p-4'>
                            ...
                            {
                                purchased ? <Button className='w-full' onClick={handleContinueCourse}>
                                    Continue Course
